...
class RuleManagerSpec(unittest.TestCase):
    ...
    def it_decorates(self):
        ...
        (a_decorator.decorate, a_person) |should| throw(AttributeError, message="Rule Manager has no xxxxx rule")
    ...
    def it_check_decoration_rules(self):
        ...
        #should be: a_decorator.decoration_rules = ['an inexistent rule']
        RuleManagerSpec.decoration_rules = ['xxxxx']
        #doing this gets the matcher as the inspect.stack()[1][0]!!!
        #(a_decorator.rule_manager.check_decoration_rules, a_person) |should| throw(AttributeError, message="Rule Manager has no xxxxx rule")
        try:
            a_decorator.rule_manager.check_decoration_rules(a_person)
        except AttributeError:
            pass
        #tear down should be: a_decorator.decoration_rules = ['should_be_instance_of_person']
